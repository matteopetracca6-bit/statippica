...
import { TrendingUp, Trophy, Dna, ChevronLeft, ChevronRight, GitCompare, Home as HomeIcon, Activity, Award, Network, BookOpen } from "lucide-react";
...
export default function Layout({ children }: LayoutProps) {
  ...
  const sidebarLinks = [
    ...
    { href: "/stallioni", label: "Catalogo Stalloni", icon: BookOpen },
